...
class PomodoroService : Service() {
    ...
    companion object {
        const val ActionPause = "dev.mks.stacks.pomodoro.PAUSE"
        const val ActionResume = "dev.mks.stacks.pomodoro.RESUME"
        const val ActionReset = "dev.mks.stacks.pomodoro.RESET"
