...
class ReaderPlaybackService : Service() {
    ...
    companion object {
        const val ActionPlay = "dev.mks.stacks.reader.PLAY"
        const val ActionToggle = "dev.mks.stacks.reader.TOGGLE"
        const val ActionSeek = "dev.mks.stacks.reader.SEEK"
        const val ActionStop = "dev.mks.stacks.reader.STOP"
