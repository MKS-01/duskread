...
class ReaderPlaybackService : Service() {
    ...
    companion object {
        const val ActionPlay = "dev.mks.duskread.reader.PLAY"
        const val ActionToggle = "dev.mks.duskread.reader.TOGGLE"
        const val ActionSeek = "dev.mks.duskread.reader.SEEK"
        const val ActionStop = "dev.mks.duskread.reader.STOP"
