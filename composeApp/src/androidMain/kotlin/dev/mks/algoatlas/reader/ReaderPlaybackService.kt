...
class ReaderPlaybackService : Service() {
    ...
    companion object {
        const val ActionPlay = "dev.mks.algoatlas.reader.PLAY"
        const val ActionToggle = "dev.mks.algoatlas.reader.TOGGLE"
        const val ActionSeek = "dev.mks.algoatlas.reader.SEEK"
        const val ActionStop = "dev.mks.algoatlas.reader.STOP"
