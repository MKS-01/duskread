...
class PomodoroService : Service() {
    ...
    companion object {
        const val ActionPause = "dev.mks.algoatlas.pomodoro.PAUSE"
        const val ActionResume = "dev.mks.algoatlas.pomodoro.RESUME"
        const val ActionReset = "dev.mks.algoatlas.pomodoro.RESET"
